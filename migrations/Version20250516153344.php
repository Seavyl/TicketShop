 ...
 */
final class Version20250516153344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);*/
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE role role JSON NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
      ...
      /*  $this->addSql(<<<'SQL'
        ...
        SQL);
        */        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE role role LONGTEXT NOT NULL COLLATE `utf8mb4_bin`
        SQL);
    }
}
